...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Suyash' , amount = 10)
...
def connect_node():
    ...
    response = { 'message' : 'All the nodes are connected.Following is the list of nodes in memecoin:',
